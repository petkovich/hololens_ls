...
class Uwb {
    ...
    // values should come from FMS and UWB nodes. It's hardcoded for testing purposes!
    std::map<int,std::string> lookup_table = {{40970, "r1"},
                                              {40990, "r2"},
                                              {40963, "r3"},
                                              {40755, "r4"}};
    // values should come from FMS. It's hardcoded for testing purposes!
    std::map<std::string, pointstamped> fms_poses;// = {{"r1", { 0.00,  0.00}},
//                                              {"r2", {-1.20, -3.60}},
//                                              {"r3", {10.20, -4.20}},
//                                              {"r4", { 5.40,  0.00}}};
    ...
    void getPath(void);
    bool return_path_srv(hololens_ls::GetHumanPath::Request& req, hololens_ls::GetHumanPath::Response& res);
    bool return_pose_srv(hololens_ls::GetRobotPose::Request& req, hololens_ls::GetRobotPose::Response& res);
